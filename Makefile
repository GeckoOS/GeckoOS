...
AS_FLAGS = -f bin
LD_FLAGS = -m elf_i386
KERNEL_OBJECTS = kernel/kernel.o kernel/mem/mem.o kernel/mem/physical_mem/physical_mem.o kernel/mem/virtual_mem/paging.o kernel/process/process.o kernel/drivers/usermode.o \
	kernel/drivers/syscalls.o
...
DRIVER_OBJECTS = kernel/drivers/vga.o kernel/drivers/keyboard.o kernel/drivers/tables/idt/idt_c.o kernel/drivers/tables/idt/idt_s.o \
	...
	kernel/drivers/tables/gdt/gdt_s.o kernel/drivers/tables/gdt/gdt_c.o kernel/drivers/tables/tss/tss_s.o kernel/drivers/tables/tss/tss_c.o
...
kernel/drivers/tables/gdt/gdt_c.o: kernel/drivers/tables/gdt/gdt.c
	$(CC) $(CC_FLAGS) $< -o $@
kernel/drivers/tables/tss/tss_c.o: kernel/drivers/tables/tss/tss.c
	$(CC) $(CC_FLAGS) $< -o $@
kernel/drivers/tables/tss/tss_s.o: kernel/drivers/tables/tss/tss.s
	$(AS) -felf32 $< -o $@
